...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency 'activesupport', [">= 3.0.0", "< 8.0"]
  s.add_runtime_dependency 'adhearsion-loquacious', ["~> 1.9"]
  s.add_runtime_dependency 'blather', ["~> 2.0"]
  s.add_runtime_dependency 'celluloid', ["~> 0.17.0"]
  ...
  s.add_runtime_dependency 'nokogiri', [">= 1.13.0", "< 2.0"]
  ...
  s.add_runtime_dependency 'thor', [">= 0.18.0", "< 2.0"]
